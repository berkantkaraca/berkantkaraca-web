                    ...
                    <form action="{{ route('about.update', $about) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description_tr" id="description_tr" rows="10" 
                                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>{{ old('description_tr', $about->description_tr) }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description_en" id="description_en" rows="10" 
                                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('description_en', $about->description_en) }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                @if($about->cv_tr_url)
                                    <p class="text-sm text-green-600 mb-2">
                                        Mevcut dosya: <a href="{{ Storage::url($about->cv_tr_url) }}" target="_blank" class="underline">CV Türkçe</a>
                                    </p>
                                @endif
                            ...
                            <div>
                                ...
                                @if($about->cv_en_url)
                                    <p class="text-sm text-green-600 mb-2">
                                        Mevcut dosya: <a href="{{ Storage::url($about->cv_en_url) }}" target="_blank" class="underline">CV English</a>
                                    </p>
                                @endif
                            ...
                            <div>
                                ...
                                @if($about->cover_letter_tr_url)
                                    <p class="text-sm text-green-600 mb-2">
                                        Mevcut dosya: <a href="{{ Storage::url($about->cover_letter_tr_url) }}" target="_blank" class="underline">Niyet Mektubu</a>
                                    </p>
                                @endif
                            ...
                            <div>
                                ...
                                @if($about->cover_letter_en_url)
                                    <p class="text-sm text-green-600 mb-2">
                                        Mevcut dosya: <a href="{{ Storage::url($about->cover_letter_en_url) }}" target="_blank" class="underline">Cover Letter</a>
                                    </p>
                                @endif
