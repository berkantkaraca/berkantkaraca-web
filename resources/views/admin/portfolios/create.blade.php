                    ...
                    <form action="{{ route('admin.portfolios.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="technology" id="technology" value="{{ old('technology') }}"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="features" id="features" rows="4"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('features') }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="security_features" id="security_features" rows="4"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('security_features') }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="microservices" id="microservices" rows="4"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('microservices') }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="technologies_used" id="technologies_used" rows="4"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('technologies_used') }}</textarea>
                        </div>
