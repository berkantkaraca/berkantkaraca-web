                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div class="p-6">
                                <div class="flex items-center mb-4">
                                    <i class="fas fa-certificate text-gray-600 text-2xl mr-3"></i>
                                    <h4 class="text-lg font-semibold text-gray-900">Sertifika Yönetimi</h4>
                                </div>
                                <p class="text-gray-600 mb-4">Sertifikalarınızı yönetin</p>
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div class="p-6">
                                <div class="flex items-center mb-4">
                                    <i class="fas fa-address-book text-gray-600 text-2xl mr-3"></i>
                                    <h4 class="text-lg font-semibold text-gray-900">İletişim Yönetimi</h4>
                                </div>
                                <p class="text-gray-600 mb-4">İletişim bilgilerinizi yönetin</p>
